...
class AlunosControllerTest < ActionController::TestCase
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post :create, aluno: { cidade: @aluno.cidade, data_nas: @aluno.data_nas, estado: @aluno.estado, nome: @aluno.nome, sexo: @aluno.sexo, sobrenome: @aluno.sobrenome, telefone: @aluno.telefone }
    end
  ...
  test "should update aluno" do
    patch :update, id: @aluno, aluno: { cidade: @aluno.cidade, data_nas: @aluno.data_nas, estado: @aluno.estado, nome: @aluno.nome, sexo: @aluno.sexo, sobrenome: @aluno.sobrenome, telefone: @aluno.telefone }
    assert_redirected_to aluno_path(assigns(:aluno))
  end
